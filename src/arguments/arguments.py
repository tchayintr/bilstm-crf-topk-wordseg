...
class ArgumentLoader(object):
    ...
    def get_full_parser(self):
        ...
        parser.add_argument(
            '--execute_mode',
            '-x',
            choices=['train', 'eval', 'decode', 'interactive'],
            help=
        ...
        parser.add_argument(
            ...
            default='sl',
            help=
            'Choose format of input data from among \'sl\' and \'wl\' (Default: sl)'
        )
        parser.add_argument(
            '--output_data_format',
            choices=['sl', 'wl'],
        ...
        parser.add_argument(
            ...
            help=
            'Specify delimiter symbol between words for SL format when output analysis results on decode/interactive mode (Default \' \')'
        )
        ...
        parser.add_argument(
            ...
            default='',
            help=
            'Sepecify labels to be ignored on evaluation by format \'label_1,label_2,...,label_N\''
        )
    ...
    def add_output_data_format_options(self, parser, args):
        if args.output_data_format == 'sl':
            ...
            print(
                'Error: output data format must be specified from among {sl, wl}: {}'
